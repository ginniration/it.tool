         <div class="box">
            ...
            <?
              ...
              $stt=1; 
              $conn = mysqli_query($db,"SELECT * FROM cp_keylicenses WHERE danhmuc='win-10' ORDER BY getdate DESC");
            ...
            ?>                    
                <tr>
                  ...
                  <td><? echo $row['slot1']; ?></td>
                  <td><? echo $row['slot2']; ?></td>
                  <td><? echo $row['slot3']; ?></td>
                  <td><? echo $row['slot4']; ?></td>
                  <td><? echo $row['slot5']; ?></td>
