...
//================================================================ THAY GIÁ TRỊ Ở ĐÂY NẾU TẠO TRANG KHÁC ===================
      $csdl = mysqli_query($db,"SELECT * FROM cp_devices");
         ...
         <div class="box">
            <div class="box-header">
              ...
              <a href="area.php?page=add-kekhai/thietbi" class="btn btn-app"><i class="fa fa-plus"></i> THÊM THIẾT BỊ</a> 
                <a href="area.php?page=kekhai/thietbi&download=alldeviced" class="btn btn-app"><i class="fa fa-download"></i> TẢI EXCEL</a> </h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            ?>                    
                <tr>
                  ...
                  <td width="15%"><? echo $row['chitiet']; ?></td>
                  <td>
                    <? lienketphanloaialldevice($row['phanloai'],$row['mataisan']); ?>
