...
//================================================================ THAY GIÁ TRỊ Ở ĐÂY NẾU TẠO TRANG KHÁC ===================
      $csdl = mysqli_query($db,"SELECT * FROM cp_devices WHERE phanloai='UPS' OR phanloai='Máy in' OR phanloai='Máy Scan' OR phanloai='Máy FAX' OR phanloai='Tivi' OR phanloai='Máy huỷ giấy' OR phanloai='Điện thoại bàn' OR phanloai='Tai Nghe' OR phanloai='USB' OR phanloai='Storage' OR phanloai='Loa' OR phanloai='Ổ cứng di động' OR phanloai='Cable' OR phanloai='DVD external'");
...
if(isset($_GET['chinhsua'])){
    ...
    if($_GET['chinhsua'] ==  NULL || $_GET['chinhsua'] == "") {
      ...
      chuyentrang('area.php?page=kekhai/thietbi&title=thiet-bi-khac');
...
if(isset($_POST['save'])){
    ...
    if($kt){
      ...
      chuyentrang('area.php?page=kekhai/thietbi&title=thiet-bi-khac&chinhsua='.$getit);
    }else{
         ...
         <div class="box">
            <div class="box-header">
              ...
              <a href="area.php?page=add-kekhai/thietbi" class="btn btn-app"><i class="fa fa-plus"></i> THÊM THIẾT BỊ</a> 
                <a href="area.php?page=kekhai/thietbi&title=thiet-bi-khac&download=<? echo $row['phanloai']; ?>" class="btn btn-app"><i class="fa fa-download"></i> TẢI EXCEL</a> </h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <?
              $c=0;
              $stt=1;
              $conn = mysqli_query($db,"SELECT * FROM cp_devices WHERE phanloai='UPS' OR phanloai='Máy in' OR phanloai='Máy Scan' OR phanloai='Máy FAX' OR phanloai='Tivi' OR phanloai='Máy huỷ giấy' OR phanloai='Điện thoại bàn' OR phanloai='Tai Nghe' OR phanloai='USB' OR phanloai='Storage' OR phanloai='Loa' OR phanloai='Ổ cứng di động' OR phanloai='Cable' OR phanloai='DVD external' ORDER BY tinhtrang ASC");
            ...
            ?>                    
                <tr>
                  ...
                  <td width="25%"><? echo $row['lichsuthietbi']; ?></td>
                   <td><a href="area.php?page=kekhai/thietbi&title=thiet-bi-khac&chinhsua=<? echo $row['mataisan']; ?>" class="btn btn-default"><i class="fa fa-edit"></i></a>                    <button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-dep<? echo $stt; ?>">
                  <i class="fa fa-eye"></i>
                </button>
              </td>
                </tr>
