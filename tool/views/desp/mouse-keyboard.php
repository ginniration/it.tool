...
//================================================================ THAY GIÁ TRỊ Ở ĐÂY NẾU TẠO TRANG KHÁC ===================
      $csdl = mysqli_query($db,"SELECT * FROM cp_devices WHERE phanloai='Chuột' OR phanloai='Bàn phím'");
...
if(isset($_GET['chinhsua'])){
    ...
    if($_GET['chinhsua'] ==  NULL || $_GET['chinhsua'] == "") {
      ...
      chuyentrang('area.php?page=kekhai/thietbi&title=chuot-banphim');
...
if(isset($_POST['save'])){
    ...
    if($kt){
      ...
      chuyentrang('area.php?page=kekhai/thietbi&title=chuot-banphim&chinhsua='.$getit);
    }else{
         ...
         <div class="box">
            <div class="box-header">
              ...
              <a href="area.php?page=add-kekhai/thietbi" class="btn btn-app"><i class="fa fa-plus"></i> THÊM THIẾT BỊ</a> 
                <a href="area.php?page=kekhai/thietbi&title=chuot-banphim&download=<? echo $row['phanloai']; ?>" class="btn btn-app"><i class="fa fa-download"></i> TẢI EXCEL</a> </h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <?
              $c=0;
              $stt=1;
              $conn = mysqli_query($db,"SELECT * FROM cp_devices WHERE phanloai='Chuột' OR phanloai='Bàn phím'");
            ...
            ?>                    
                <tr>
                  ...
                  <td width="25%"><? echo $row['lichsuthietbi']; ?></td>
                   <td><a href="area.php?page=kekhai/thietbi&title=chuot-banphim&chinhsua=<? echo $row['mataisan']; ?>" class="btn btn-default"><i class="fa fa-edit"></i></a>
