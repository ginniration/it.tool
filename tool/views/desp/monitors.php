...
//================================================================ THAY GIÁ TRỊ Ở ĐÂY NẾU TẠO TRANG KHÁC ===================
      $csdl = mysqli_query($db,"SELECT * FROM cp_devices WHERE phanloai='Màn hình máy tính'");
      $row = mysqli_fetch_array($csdl,MYSQLI_ASSOC); 
      $manhinh = md5($row['phanloai']);
//=========================================================================================================================
if(isset($_GET['chinhsua'])){
    ...
    if($_GET['chinhsua'] ==  NULL || $_GET['chinhsua'] == "") {
      ...
      chuyentrang('area.php?page=kekhai/thietbi&title=man-hinh');
...
if(isset($_POST['save'])){
    ...
    if($kt){
      ...
      chuyentrang('area.php?page=kekhai/thietbi&title=man-hinh&chinhsua='.$getit);
    }else{
    ...
    $rahon = md5($chon['phanloai']);
        ...
        chuyentrang('./excel/export.php?choose='.$chons.'');
         ...
         <div class="box">
            <div class="box-header">
              ...
              <a href="area.php?page=add-kekhai/thietbi" class="btn btn-app"><i class="fa fa-plus"></i> THÊM THIẾT BỊ</a> 
                <a href="area.php?page=kekhai/thietbi&title=man-hinh&download=<? echo $row['phanloai']; ?>" class="btn btn-app"><i class="fa fa-download"></i> TẢI EXCEL</a> </h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <?
              $c=0;
              $stt=1;
              $conn = mysqli_query($db,"SELECT * FROM cp_devices WHERE phanloai='Màn hình máy tính'");
            ...
            ?>                    
                <tr>
                  ...
                  <td width="25%"><? echo $row['lichsuthietbi']; ?></td>
                   <td><a href="area.php?page=kekhai/thietbi&man-hinh&chinhsua=<? echo $row['mataisan']; ?>" class="btn btn-default"><i class="fa fa-edit"></i></a>                    
                   <button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-dep<? echo $stt; ?>">
                  <i class="fa fa-eye"></i>
                </button>
              </td>
                </tr>
