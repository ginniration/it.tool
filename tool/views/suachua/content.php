         ...
         <div class="box">
            <div class="box-header">
              <h3 class="box-title">
             	<a href="area.php?page=bao-cao-sua-chua&them" class="btn btn-app"><i class="fa fa-plus"></i> THÊM BÁO CÁO</a>              	
              	<a href="area.php?page=bao-cao-sua-chua&download=report-fixed" class="btn btn-app"><i class="fa fa-download"></i> TẢI BÁO CÁO </a>
              </h3>
            </div>          
            <div class="box-header">
            ...
            <?
              $c=0;
         	  $stt=1;	
              $conn = mysqli_query($db,"SELECT * FROM cp_reports_fixed WHERE loai='Sửa chữa' ");
            ...
            ?>                    
                <tr>
                  ...
                  <td><? if($row['ticket'] == NULL || $row['ticket'] == "" || $row['ticket'] == "0"){echo "None";}else { echo "<a href='http://support.imt-soft.com/issues/".$row['ticket']."' target='_blank'>".$row['ticket']."</a>"; }?></td>
                  <td><? echo $row['ngay']; ?></td>
                  ...
                  <td><a href="area.php?page=bao-cao-sua-chua&chinhsua=<? echo $row['mataisan']; ?>" class="btn btn-default"><i class="fa fa-edit"></i></a> </td>
                </tr>
            <? $c++; $stt++; } ?> 
                </tbody>
              </table>
