...
?>    
         ...
         <div class="box">
            <div class="box-header">
              <h3 class="box-title">Excel : <a href="area.php?page=kekhai/thietbi&download=alldeviced" class="btn btn-app"><i class="fa fa-download"></i> TẢI VỀ</a> </h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            ?>                    
                <tr>
                  ...
                  <td><a href="#" class="btn btn-default"><i class="fa fa-remove"></i></a> </td>
                </tr>
            <? $c++; $stt++; } ?> 
                </tbody>
              </table>
