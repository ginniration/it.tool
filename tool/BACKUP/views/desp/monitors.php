...
?>    
         <div class="box">
            <div class="box-header">
              <h3 class="box-title">Excel : <a href="area.php?page=kekhai/thietbi&title=man-hinh&download=<? echo $row['phanloai']; ?>" class="btn btn-app"><i class="fa fa-download"></i> TẢI VỀ</a> </h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            ?>                    
                <tr>
                  ...
                  <td width="30%"><? echo $row['lichsuthietbi']; ?></td>
                   <td><a href="area.php?page=kekhai/thietbi&man-hinh&chinhsua=<? echo $row['mataisan']; ?>" class="btn btn-default"><i class="fa fa-edit"></i></a> </td>
                </tr>
            <? $c++; $stt++; } ?> 
                </tbody>
              </table>
