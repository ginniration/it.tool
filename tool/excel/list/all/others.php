...
// TIÊU ĐỀ CỦA EXCEL
->setCellValue('G1', 'IMT SOLUTIONS -  ASSET LIST - 2019')
->setCellValue('A3', 'STT')
...
$numRow = 5;
$stt=1; 
$conn = mysqli_query($db,"SELECT * FROM cp_devices WHERE phanloai='UPS' OR phanloai='Máy in' OR phanloai='Máy Scan' OR phanloai='Máy FAX' OR phanloai='Tivi' OR phanloai='Máy huỷ giấy' OR phanloai='Điện thoại bàn' OR phanloai='Tai Nghe' OR phanloai='USB' OR phanloai='Storage' OR phanloai='Loa' OR phanloai='Ổ cứng di động' OR phanloai='Cable' OR phanloai='DVD external' ORDER BY phanloai");
...
$excel->getActiveSheet()->setTitle("Others");
?>