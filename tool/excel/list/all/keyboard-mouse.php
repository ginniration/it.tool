...
// TIÊU ĐỀ CỦA EXCEL
->setCellValue('G1', 'IMT SOLUTIONS - MOUSE & KEYBOARDS ASSET- 2019')
->setCellValue('A3', 'STT')
...
$numRow = 5;
$stt=1; 
$conn = mysqli_query($db,"SELECT * FROM cp_devices WHERE phanloai='Bàn phím' OR phanloai='Chuột' ORDER BY phanloai");
...
$excel->getActiveSheet()->setTitle("Mouse - Keyboard");
?>