...
// TIÊU ĐỀ CỦA EXCEL
->setCellValue('G1', 'IMT SOLUTIONS -  SOCKET ASSET - 2019')
->setCellValue('A3', 'STT')
...
$numRow = 5;
$stt=1; 
$conn = mysqli_query($db,"SELECT * FROM cp_devices WHERE phanloai='Ổ cắm điện' ORDER BY phanloai");
...
$excel->getActiveSheet()->setTitle("Ổ cắm điện");
?>