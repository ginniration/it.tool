...
$excel->getActiveSheet()->setTitle("Mouse - Keyboards");
 ...
 */
// TIÊU ĐỀ CỦA EXCEL
$excel->getActiveSheet()->setCellValue('G1', 'IMT SOLUTIONS -  MOUSE & KEYBOARDS ASSET - 2019');
//====================================================================================
...
$numRow = 5;
$stt=1; 
$conn = mysqli_query($db,"SELECT * FROM cp_devices WHERE phanloai='Chuột' OR phanloai='Bàn phím' ORDER BY phanloai");
