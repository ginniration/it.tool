...
$excel->getActiveSheet()->setTitle("PC - MacMINI");
 ...
 */
// TIÊU ĐỀ CỦA EXCEL
$excel->getActiveSheet()->setCellValue('G1', 'IMT SOLUTIONS -  PC & MACMINI LIST - 2019');
//====================================================================================
...
$numRow = 5;
$stt=1; 
$conn = mysqli_query($db,"SELECT * FROM cp_devices WHERE phanloai='PC' OR phanloai='MacMINI' ORDER BY phanloai");
