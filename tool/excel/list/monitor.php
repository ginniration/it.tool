...
$excel->getActiveSheet()->setTitle("Monitors");
 ...
 */
// TIÊU ĐỀ CỦA EXCEL
$excel->getActiveSheet()->setCellValue('G1', 'IMT SOLUTIONS -  MONITORS ASSET - 2019');
//====================================================================================
...
$numRow = 5;
$stt=1; 
$conn = mysqli_query($db,"SELECT * FROM cp_devices WHERE phanloai='Màn hình máy tính' ORDER BY phanloai");
